...
const Payment = () => {
  ...
  const handleMoMoPayment = async () => {
    ...
    try {
      ...
      alert(
        "Chức năng thanh toán MoMo đang được phát triển. Đơn hàng sẽ chuyển sang trạng thái chờ thanh toán."
      );
      clearCart();
  ...
  const handleVNPayPayment = async () => {
    ...
    try {
      ...
      // TODO: Integrate with VNPay payment gateway
      // For now, redirect to order success
      alert(
        "Chức năng thanh toán VNPay đang được phát triển. Đơn hàng sẽ chuyển sang trạng thái chờ thanh toán."
      );
      clearCart();
      navigate(`/order-success/${orderResponse.data._id}`);
    } catch (error) {
  ...
  const handleZaloPayPayment = async () => {
    ...
    try {
      ...
      // TODO: Integrate with ZaloPay payment gateway
      // For now, redirect to order success
      alert(
        "Chức năng thanh toán ZaloPay đang được phát triển. Đơn hàng sẽ chuyển sang trạng thái chờ thanh toán."
      );
      clearCart();
      navigate(`/order-success/${orderResponse.data._id}`);
    } catch (error) {
            ...
            <div className="payment-method-details">
              ...
              <div className="payment-instructions">
                ...
                <ul>
                  ...
                  <li>✓ Quay lại trang web để kiểm tra đơn hàng</li>
                </ul>
              </div>
          ...
          {paymentMethod.code === "vnpay" && (
            <div className="payment-method-details">
              ...
              <div className="payment-instructions">
                <h4>📝 Hướng dẫn:</h4>
                <ul>
                  <li>✓ Chuyển đến cổng thanh toán VNPay</li>
                  <li>✓ Chọn phương thức thanh toán (thẻ ATM/tài khoản/QR)</li>
                  <li>✓ Nhập thông tin và xác nhận</li>
          ...
          {paymentMethod.code === "zalopay" && (
            <div className="payment-method-details">
              ...
              <button
                ...
                disabled={loading}
              >
                {loading ? "Đang xử lý..." : "Thanh Toán Với ZaloPay"}
              </button>
            </div>
          )}
